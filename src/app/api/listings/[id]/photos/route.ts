...
export async function POST(
  ...
  try {
    ...
    // Build rows with incremental sortOrder
    ...
    // createMany returns count only; fetch afterwards to return created rows
    await db.listingPhoto.createMany({ data: rows, skipDuplicates: true });
